 ...
 * 
 * datagrid.class.php Update for PHP 5
 * 
 * This class was written using PHP 5
...
class datagrid {
 ...
 VAR $registo_index = "1";
	...
	function template_db() {
		...
		$connection = mysqli_connect("127.0.0.1","root","", "datagrid") or die("Erro: " .mysql_error());
		...
		while ($sqlReg=mysqli_fetch_array($result)) {
				...
				return "<table Border='0' cellspacing='10' cellpadding='0' width='300'>
					<tr>
						<td rowspan='3'><img src=" . $sqlReg[$arr[1]] . " height='100'></td>
						<td colspan='2' cellspacing='0'><b><font size='4'>".$sqlReg[$arr[2]]."</font></b></td>
					</tr>
						<tr><td colspan='2'>".$sqlReg[$arr[3]]."</td>
					</tr>
						<tr><td><b><font color='white'>Price: </b></font>".$sqlReg[$arr[4]]."€</td>
						<td>chart</td>
					</tr>
					</table>";
		}
